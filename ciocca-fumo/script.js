...
function setCategory(cat) {
  ...
  render();
  if (activeCategory === "fotografie" && !handDetector) {
  initPortraitGesture();
}
...
document.getElementById("open-explore-btn")?.addEventListener("click", openExploreModal);
document.getElementById("close-explore-btn")?.addEventListener("click", closeExploreModal);